...
WebUI.clearText(findTestObject('MyInfo/input_FirstName'))

WebUI.sendKeys(findTestObject('MyInfo/input_FirstName'), Keys.chord(Keys.BACK_SPACE))

WebUI.verifyElementVisible(findTestObject('MyInfo/label_ErrorMessageFirstName'))

WebUI.verifyElementText(findTestObject('MyInfo/label_ErrorMessageFirstName'), 'This field is required', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('MyInfo/button_Edit'))

WebUI.verifyElementVisible(findTestObject('MyInfo/label_ErrorMessageFirstName'))

WebUI.clearText(findTestObject('MyInfo/input_LastName'))

WebUI.sendKeys(findTestObject('MyInfo/input_LastName'), Keys.chord(Keys.BACK_SPACE))

WebUI.verifyElementVisible(findTestObject('MyInfo/label_ErrorMessageLastName'))

WebUI.verifyElementText(findTestObject('MyInfo/label_ErrorMessageLastName'), 'This field is required', FailureHandling.CONTINUE_ON_FAILURE)
